...
public interface Project_ConstantStrings {

    String SET_DEVICES = "grid_set_devices";
    String SET_TECHNOLOGIES = "grid_set_technologies";
    ...
    String sHome_btnText = "Expand Project_WorkSpace";
    ...
    String kw_Development = "Development";
    ...
    String markupLanguageInfo = "Markup Language \n"
            ...
            + "Italizie Text = '*' and '_'" + "\n"
            + "Strike Through Text = '~~'" + "\n\n"
            + "Unorder List (unorder list will appear when an dash and indent are present.) = '-' or '	-'" + "\n"
            + "Order List (order list will be created when a number is the first character followed by a perid.) = '1.'" + "\n\n"
            + "Quote Text (must be the first chrater on the line) = '>'" + "\n\n"
            // TODO REMEBER TO FIND THE SPELLING OF THIS
            + "Code formated text (will present itself only if wrapped from top to bottom using the tripple appostraphey(?)) = '''" ;
